<template>
    <div id="add" v-if="action">
        ...
        <div class="detailsBox">
            <div class="details">
                <!--<router-link tag="div" class="add icon-hover" style="right:10px;" 
                	:to="{name:(addData.pageName == 'product'? 'ruleSetConfig' : 'ruleConfig'), query:{actionName:'create'}}">
                    <svg-icon class="icons" id="icon-add"></svg-icon>
                </router-link>-->
                <router-link tag="div" class="add icon-hover" style="right:10px;" 
					:to="{name:(addData.pageName == 'product'? 'ruleSetConfig' : 'ruleConfig'), 
					query:{actionName:'create',type:addData.pageName != 'product'?Number(selectVal):false}}">
                    <svg-icon class="icons" id="icon-add"></svg-icon>
                </router-link>
