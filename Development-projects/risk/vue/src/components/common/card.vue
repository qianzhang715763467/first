	...
	<div class="card" id="card" v-if="ready()">
		...
		<section class="card-box">
			<router-link  tag="a" class="card-main" @click.native="routerToDetailsPage()" 
				:to="{name:cardParams.click == 'no' ? false:'details',
				params:{
					id:cardParams.click == 'no'? false : params.values.id, 
					pageName:cardParams.click == 'no' ? false : this.$route.name,
					type:cardParams.click == 'no' ? false:(params.detailsPageName=='group'?cardParams.values.isCloud:false)
					}
				}" >
